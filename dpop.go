...
// [Security Enhancement] This function returns the securely parsed and verified DPoPProof claims
// to prevent subsequent usage of ParseUnverified in the application layer.
